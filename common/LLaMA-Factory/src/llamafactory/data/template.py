...
_register_template(
    ...
    efficient_eos=True,
    default_system=(
        'I want you to act as a skilled agent in TextWorld, an engine for interactive text-based games. '
        'You task is to provide a structured action based on the game context, which includes the current game state ("[STATE]") '
        'and your previous actions ("[action]"). Note that all objects involved in an action should be mentioned in the context '
        'to adhere to game rules of TextWorld.\n'
    ),
)
